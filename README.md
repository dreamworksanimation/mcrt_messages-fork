# mcrt_messages - part of the [MoonRay](https://github.com/OpenMoonRay/openmoonray) project
...
This repository contains the message content classes used by the mcrt computation
